const questions = [
    ...
    "Had used ChatGPT (or AI) to write part of an assignment?",
    ...
    "Had slept on the forbidden WALC couches? (iykyk)",
    ...
    "Had purposefully stopped a starship robot?",
    "Had sled off of Slayter hill?",
